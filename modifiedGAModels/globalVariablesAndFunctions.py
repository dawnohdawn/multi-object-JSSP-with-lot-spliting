...
# P0：4X6问题，来自王海燕，不分批
if (problemInd == 0):
    timeMatrix = [[{0: 16, 1: 24, 2: 32}, {1: 24, 3: 16, 4: 32}, {0: 8, 1: 32, 2: 40}], \
                  [{0: 24, 2: 40, 4: 16}, {0: 32, 1: 24, 4: 48}, {2: 32, 4: 56, 5: 88}], \
                  [{0: 40, 1: 48}, {1: 32, 3: 24, 4: 40}, {2: 104, 4: 72, 5: 96}], \
                  [{0: 72, 2: 56, 3: 72}, {1: 48, 3: 32, 5: 40}, {0: 8, 2: 24, 5: 24}]]
...
# P4：6X6问题，来自王海燕
    ...
    timeMatrix = [[{0: 10, 1: 11, 2: 9, 3: 8, 4: 9}, {5: 2, 6: 3}, {0: 7, 1: 8, 2: 9, 3: 10, 4: 11}, {5: 3, 6: 2},
                        {0: 8, 1: 7, 2: 6, 3: 7, 4: 8}, {7: 3}], \
                  [{0: 7, 1: 7, 2: 8, 3: 7, 4: 9}, {5: 2, 6: 2}, {0: 9, 1: 6, 2: 7, 3: 10, 4: 9}, {5: 2, 6: 3},
                        {0: 3, 1: 4, 2: 3, 3: 4, 4: 5}, {7: 3}], \
                   [{0: 7, 1: 8, 2: 9, 3: 7, 4: 8}, {5: 2, 6: 3}, {0: 10, 1: 6, 2: 8, 3: 6, 4: 7}, {5: 3, 6: 2},
                        {0: 3, 1: 4, 2: 4, 3: 3, 4: 5}, {7: 3}]]

    preparingTimeMatrix = [[{0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 2, 6: 1}, {0: 2, 1: 2, 2: 1, 3: 1, 4: 1}, {5: 2, 6: 1},
                                {0: 2, 1: 2, 2: 1, 3: 1, 4: 2}, {7: 1}], \
                           [{0: 2, 1: 2, 2: 1, 3: 2, 4: 1}, {5: 1, 6: 1}, {0: 1, 1: 2, 2: 2, 3: 1, 4: 2}, {5: 1, 6: 1},
                                {0: 2, 1: 1, 2: 2, 3: 1, 4: 3}, {7: 1}], \
                           [{0: 1, 1: 1, 2: 2, 3: 2, 4: 1}, {5: 1, 6: 2}, {0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 2, 6: 1},
                                {0: 1, 1: 1, 2: 2, 3: 2, 4: 1}, {7: 1}]]
    lotSizes = [8, 8, 8]
    Cmachine = [0, 1, 2, 3, 4]
    ...
    timeMatrix = [[{0: 9, 1: 10, 2: 11, 3: 8, 4: 11}, {5: 3, 6: 3}, {0: 9, 1: 8, 2: 10, 3: 11, 4: 9}, {5: 3, 6: 2},
                        {0: 6, 1: 7, 2: 6, 3: 7, 4: 6}, {7: 3}], \
                   [{0: 9, 1: 8, 2: 8, 3: 7, 4: 9}, {5: 2, 6: 2}, {0: 6, 1: 7, 2: 9, 3: 5, 4: 5}, {5: 2, 6: 3},
                        {0: 5, 1: 4, 2: 3, 3: 4, 4: 4}, {7: 3}], \
                   [{0: 10, 1: 11, 2: 9, 3: 8, 4: 9}, {5: 2, 6: 3}, {0: 7, 1: 8, 2: 9, 3: 10, 4: 11}, {5: 3, 6: 2},
                        {0: 8, 1: 7, 2: 6, 3: 7, 4: 8}, {7: 3}], \
                   [{0: 7, 1: 7, 2: 8, 3: 7, 4: 9}, {5: 2, 6: 2}, {0: 9, 1: 6, 2: 7, 3: 10, 4: 9}, {5: 2, 6: 3},
                        {0: 3, 1: 4, 2: 3, 3: 4, 4: 5}, {7: 3}], \
                   [{0: 7, 1: 8, 2: 9, 3: 7, 4: 8}, {5: 2, 6: 3}, {0: 10, 1: 6, 2: 8, 3: 6, 4: 7}, {5: 3, 6: 2},
    ...
    preparingTimeMatrix = [[{0: 2, 1: 1, 2: 2, 3: 1, 4: 1}, {5: 2, 6: 1}, {0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 1, 6: 1},
                                {0: 2, 1: 1, 2: 1, 3: 2, 4: 1}, {7: 1}], \
                           [{0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 1, 6: 2}, {0: 2, 1: 2, 2: 1, 3: 1, 4: 1}, {5: 2, 6: 1},
                                {0: 2, 1: 1, 2: 2, 3: 2, 4: 2}, {7: 1}], \
                           [{0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 2, 6: 1}, {0: 2, 1: 2, 2: 1, 3: 1, 4: 1}, {5: 2, 6: 1},
                                    {0: 2, 1: 2, 2: 1, 3: 1, 4: 2}, {7: 1}], \
                           [{0: 2, 1: 2, 2: 1, 3: 2, 4: 1}, {5: 1, 6: 1}, {0: 1, 1: 2, 2: 2, 3: 1, 4: 2}, {5: 1, 6: 1},
                                    {0: 2, 1: 1, 2: 2, 3: 1, 4: 3}, {7: 1}], \
                           [{0: 1, 1: 1, 2: 2, 3: 2, 4: 1}, {5: 1, 6: 2}, {0: 1, 1: 2, 2: 1, 3: 2, 4: 2}, {5: 2, 6: 1},
...
# 最好结果 = 68
    ...
    timeMatrix = [[{0: 4, 1: 4, 3: 5, 4: 1}, {0: 7, 4: 8, 5: 5}, {1: 5, 3: 5, 4: 6}],
 [{0: 8, 1: 2, 2: 1, 3: 3}, {1: 5, 2: 3}, {0: 1, 1: 4, 2: 8, 3: 7}],
 [{0: 3, 4: 7}, {0: 5, 1: 8, 2: 7, 5: 1}, {0: 7, 1: 8, 2: 3, 4: 2}],
 [{2: 3, 5: 1}, {3: 1, 4: 2, 5: 1}, {0: 3, 2: 5, 3: 2, 4: 7}]]
    preparingTimeMatrix = [[{0: 4, 1: 1, 3: 2, 4: 2}, {0: 1, 4: 2, 5: 2}, {1: 3, 3: 3, 4: 4}],
 [{0: 4, 1: 4, 2: 1, 3: 4}, {1: 4, 2: 3}, {0: 3, 1: 3, 2: 3, 3: 2}],
 [{0: 4, 4: 3}, {0: 4, 1: 3, 2: 4, 5: 2}, {0: 2, 1: 3, 2: 1, 4: 2}],
 [{2: 2, 5: 3}, {3: 4, 4: 3, 5: 3}, {0: 3, 2: 3, 3: 2, 4: 2}]]
    lotSizes = [10, 10, 10, 10]
...
# 最好结果 = 67
 ...
 [{1: 6, 2: 7, 3: 2, 4: 2},
  {0: 1, 1: 1, 3: 8, 4: 7, 5: 2},
  {0: 7, 1: 1, 2: 6, 4: 8, 5: 8}]]
    preparingTimeMatrix = [[{0: 1, 1: 4, 2: 3, 4: 3},
  {0: 3, 1: 2, 2: 1, 4: 4},
  {2: 1, 3: 3, 4: 2, 5: 1}],
